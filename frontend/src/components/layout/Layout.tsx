...
export default function Layout() {
  ...
  return (
    <div style={{ display: 'flex', height: '100vh', overflow: 'hidden' }}>
      <aside style={{
        ...
        <div style={{ padding: '0 var(--space-6) var(--space-8)' }}>
          <span style={{
            ...
            fontSize: 16, color: 'var(--accent)', letterSpacing: '-0.5px',
          }}>
        ...
        <div style={{
          padding: 'var(--space-6)', borderTop: '1px solid var(--bg-border)',
      ...
      <main style={{
        flex: 1, overflow: 'auto', padding: 'var(--space-8)',
...
function ConnectionBadge({ label, connected }: { label: string; connected?: boolean }) {
  return (
    <div style={{ display: 'flex', alignItems: 'center',
      justifyContent: 'space-between', fontSize: 12, color: 'var(--text-secondary)' }}>
      <span>{label}</span>
